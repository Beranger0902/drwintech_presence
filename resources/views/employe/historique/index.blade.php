        ...
        <main class="content">
            <div class="content-page-header">
                ...
                <div class="page-breadcrumb-row">
                    ...
                    <span>/</span>
                    <a href="{{ route('employe.historique.index') }}" class="active-breadcrumb">Historique</a>
                </div>
            </div>

            <div class="filter-card">
                <div class="filter-title">Filtrer les pointages</div>

                <form method="GET" action="{{ route('employe.historique.index') }}" class="filter-form">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display:flex; gap:10px;">
                            ...
                            <a href="{{ route('employe.historique.index') }}" class="reset-btn">Réinitialiser</a>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Statut</th>
                                <th>Latitude Arrivée</th>
                                <th>Longitude Arrivée</th>
                        ...
                        <tbody>
                            @forelse ($historiques as $historique)
                                <tr>
                                    <td>{{ \Carbon\Carbon::parse($historique->date_presence)->format('d/m/Y') }}</td>
                                    ...
                                    <td>{{ $historique->longitude_arrivee ?? '-' }}</td>
                                    <td>{{ $historique->latitude_depart ?? '-' }}</td>
                                    <td>{{ $historique->longitude_depart ?? '-' }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="8" style="text-align:center;">Aucun historique trouvé.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
