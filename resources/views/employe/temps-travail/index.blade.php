            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-head">
                        ...
                        <span>Heures de travail semaine</span>
                    </div>
                    <div class="stat-value">{{ $stats['heures_semaine'] }}</div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $stats['jours_travailles'] }}</div>
                </div>
            </div>

            <div class="charts-grid">
                <div class="chart-card">
                    <div class="chart-title">Heures de travail par jour</div>

                    <div class="bar-chart">
                        @foreach ($stats['heures_par_jour'] as $index => $heure)
                            @php
                                $hauteur = max(10, $heure * 25);
                            @endphp
                            <div class="bar-item">
                                <div class="bar-value">{{ number_format($heure, 1) }}h</div>
                                <div class="bar" style="height: {{ $hauteur }}px;"></div>
                                <div class="bar-label">{{ $stats['jours_labels'][$index] }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
                    <div class="pie-wrap">
                        <div class="pie-chart" style="--normal: {{ $stats['pourcentage_normal'] }};">
                            <div class="pie-center">
                                <span>Travail</span>
                                <strong>{{ $stats['pourcentage_normal'] }}%</strong>
                            </div>
                        </div>
                        ...
                        <div class="legend">
                            <div class="legend-item">
                                ...
                                <span>Temps normal</span>
                            </div>

                            <div class="legend-item">
                                <span class="legend-color legend-orange"></span>
                                <span>Heures supp. ({{ $stats['pourcentage_supp'] }}%)</span>
                            </div>
                        </div>
                    </div>
                </div>
